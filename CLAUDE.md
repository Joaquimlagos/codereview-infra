...
- **`codereview-lambda`** — the Lambda functions themselves: code, IAM roles, deploy (complexity classification via the Jev decision engine, RAG context, LLM calls straight to Groq and Gemini with model fallback, posting the review back to the PR).
